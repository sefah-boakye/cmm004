                                ...
                                <div class="right_header_info">
                                    <ul>
                                        <li class="dinone">Contact Us : <img
                                                ...
                                                style="padding: 10px 20px; background-color: #007bff; color: #fff; text-decoration: none; border-radius: 5px;">Call
                                                Us</a>
                                        <li class="dinone"><img style="margin-right: 15px;" src="images/mail_icon.png"
                                                alt="#"><a href="mailto:sefaboakye41@gmail.com"
                                                style="padding: 10px 20px; background-color: #007bff; color: #fff; text-decoration: none; border-radius: 5px;">Message
                                                Us</a>
                                        <li class="dinone"><img
                                                style="margin-right: 15px;height: 21px;position: relative;top: -2px;"
                                                src="images/location_icon.png" alt="#"><a href="#">Garthee,Aberdeen -
                                                UK</a></li>
                                        <li class="button_user"><a class="button active"
                                                href=file:///C:/Users/henry/OneDrive/Desktop/De-Chef%20Free%20Website%20Template%20-%20Free-CSS.com/De-Chef/login.html>Login</a><a
                                                class="button"
                                                href="file:///C:/Users/henry/OneDrive/Desktop/De-Chef%20Free%20Website%20Template%20-%20Free-CSS.com/De-Chef/registration.html">Register</a>
                                        </li>
